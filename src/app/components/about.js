        ...
        <div className="container mx-auto">
          {title || desc ? (
            <div className="grid grid-cols-1 pb-8 text-center">
              ...
              <p className="text-[color:var(--dark-grey-color)] md:text-xl text-xl max-w-3xl mx-auto">{desc}</p>
            </div>
          ) : (
            ""
          )}
            ...
            <div className="lg:col-span-7">
              <div className="lg:ms-7">
                ...
                <p className="text-[color:var(--dark-grey-color)]  dark:text-slate-300 max-w-2xl font-inter mx-auto">
                  ...
                  transformative experience. Our Tunisian founder, having
                  navigated the complexities of relocating to Germany herself,
                  faced numerous challenges along the way. Together with her
                  German co-founder, who brought deep knowledge of the local job
                  market and hiring challenges, they frequently advised others
                  facing similar obstacles.
                </p>
                <br />
                <p className="text-[color:var(--dark-grey-color)] dark:text-slate-300 max-w-2xl font-inter mx-auto">
                  Motivated by their shared commitment to support and guide
                  others, they envisioned StorkLink as a solution to link
                  ambition and opportunity. Their combined expertise and
                  dedication led to the creation of a company focused on
                  simplifying the process for candidates while delivering
                  valuable talent to German employers.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="lg:col-span-7">
              <div className="lg:ms-7">
                ...
                <p className="text-[color:var(--dark-grey-color)] dark:text-slate-300 max-w-2xl font-inter mx-auto">
                  ...
                  inclusion by connecting Tunisian talent with opportunities in
                  Germany. We prioritize the unique needs of our candidates and
                  clients, offering tailored, compassionate solutions. Our
                  mission is to create meaningful connections that benefit both
                  individuals and organizations, reflecting the diversity of the
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 md:grid-cols-2 gap-10 items-center">
            ...
            <div className="lg:col-span-7">
              <div className="lg:ms-7">
                ...
                <p className="text-[color:var(--dark-grey-color)] dark:text-slate-300 max-w-2xl font-inter mx-auto">
                  StorkLink strives to be the premier connector of Tunisian
                  talent with opportunities in Germany, driven by expertise and
                  fairness. We specialize in aligning exceptional talent with
                  the right roles, meeting both current and future market
                  demands.
                </p>
                <br />
                <p className="text-[color:var(--dark-grey-color)] dark:text-slate-300 max-w-2xl font-inter mx-auto">
                  ...
                  equity, diversity, and inclusion, we create impactful pathways
                  that drive innovation and contribute to a dynamic global
                  workforce.
                </p>
              </div>
            </div>
            ...
            <div className="lg:col-span-7">
              <div className="lg:ms-7">
                ...
                <p className="text-[color:var(--dark-grey-color)] dark:text-slate-600 max-w-2xl font-inter mx-auto">
                  ...
                  businesses through precision, empathy, and integrity. Our core
                ...
                <ul className="list-disc mt-6">
                  <li className="text-[color:var(--darkest-grey-color)] mx-5">
                    ...
                    <span className="text-[color:var(--dark-grey-color)] dark:text-slate-500 max-w-2xl font-inter mx-auto">
                      We use our deep understanding of the Tunisian and German
                      markets to provide tailored support, effectively matching
                      talent with the right roles.
                    </span>
                  </li>
                  <li className="text-[color:var(--darkest-grey-color)] mx-5">
                  ...
                  <li className="text-[color:var(--darkest-grey-color)] mx-5">
                    ...
                    <span className="text-[color:var(--dark-grey-color)] dark:text-slate-500 max-w-2xl font-inter mx-auto">
                      ...
                      insights to help businesses and talent stay relevant in a
                      changing landscape.
                    </span>
                  </li>
                  <li className="text-[color:var(--darkest-grey-color)] mx-5">
                    ...
                    <span className="text-[color:var(--dark-grey-color)] dark:text-slate-500 max-w-2xl font-inter mx-auto">
                      We strive for high-quality, efficient services, exceeding
                      expectations and contributing to our clients and
                      candidates success.
                    </span>
                  </li>
                  <li className="text-[color:var(--darkest-grey-color)] mx-5">
                    ...
                    <span className="text-[color:var(--dark-grey-color)] dark:text-slate-500 max-w-2xl font-inter mx-auto">
                      We prioritize equity and inclusion, ensuring opportunities

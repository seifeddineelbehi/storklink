...
export default function TalentServices() {
    return (
        <section className="relative md:py-24 py-16 bg-[color:var(--light-grey-color)]" id="services-talent">
            <div className="container lg mx-auto">
     
                <br/>   
                <div className="grid grid-cols-1 pb-8 text-center">
                        <h4 className="text-[color:var(--darkest-grey-color)] mb-4 md:text-5xl text-4xl font-medium font-lexend">Services For Talents</h4>
                        <p className="text-slate-500 md:text-xl text-xl max-w-3xl mx-auto">Ready to advance your career 
                            in Germany?<br/> Contact us to discover how StorkLink can connect you with 
                            top employers and help you achieve your professional goals.
                        </p>
                    </div>  
                    <br/>   
